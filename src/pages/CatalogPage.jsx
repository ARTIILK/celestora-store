    ...
    if (!category) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center text-center p-4">
                ...
                <Link href="/">
                    <Button className="bg-primary hover:bg-primary/90 text-white rounded-lg px-8 h-12 font-bold transition-all hover:scale-105 active:scale-95">
                        Return Home
                    </Button>
                </Link>
            </div>
    ...
    return (
        <div className="relative w-full min-h-screen pb-20 pt-32">
            ...
            <header className="relative mb-20 px-4">
                <div className="max-w-7xl mx-auto relative overflow-hidden rounded-xl border border-white/20 glass-panel p-12 md:p-24 text-center">
                    {/* Ambient Glows */}
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {categoryProducts.length === 0 && (
                    <div className="text-center py-40 glass-panel rounded-xl border border-white/10">
